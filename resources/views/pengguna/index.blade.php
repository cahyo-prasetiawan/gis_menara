...
<div class="card">
   ...
   <div class="table-responsive text-nowrap">
             <div class="d-flex align-items-center justify-content-between">
              <a href="pengguna/create" class="btn btn-primary ms-3 mb-2" >Tambah data</a>
              <!-- Modal -->
              <form method="GET" action="/pengguna">
           ...
           <td>
             <div class="dropdown">
               ...
               <div class="dropdown-menu">
                 <a href="/pengguna/{{ $user->id }}/edit" class="dropdown-item " 
