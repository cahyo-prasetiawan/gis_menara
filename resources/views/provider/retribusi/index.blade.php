...
@endif
<div class="card">
  <h5 class="card-header">Data Retribusi</h5>
  <div class="table-responsive text-nowrap">
   <div class="row">
            <div class="col-md-8">
             <a href="retribusi/create" class="btn btn-primary ms-3 mb-2">Tambah data</a>
             <a href="/kirim" class="btn btn-primary ms-3 mb-2">Kirim Tagihan</a>
           </div>
            <div class="col-md-4">
       ...
       @if(count($retribusis)>0)
        ...
        <tr>
         <input type="hidden" class="delete_id" value="{{ $retribusi->id}}">
          ...
          <td>{{ Carbon\Carbon::parse($retribusi->jatuh_tempo)->format('d M Y')}}</td>
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a  class="dropdown-item editbtn" href="/retribusi/{{ $retribusi->id}}/edit"
                  ><i class="bx bx-edit-alt me-1"></i> Edit</a
                >
                <a  class="dropdown-item editbtn" href="/retribusi/{{ $retribusi->tagihan}}"
