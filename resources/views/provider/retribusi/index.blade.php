...
<div class="card">
   ...
   <div class="table-responsive text-nowrap">
             <div class="d-flex align-items-center justify-content-between">
              ...
              <form method="GET" action="/retribusi">
     ...
     <table class="table table-hover">
       ...
       <tbody class="table-border-bottom-0">
        @if(count($retribusis)>0)
         ...
         <tr>
          <input type="hidden" class="delete_id" value="{{ $retribusi->tagihan }}">
           <td>{{ $loop->iteration }}</td>
           <td>{{ $retribusi->provider->name }}</td>
           <td>{{ $retribusi->tagihan }}</td>
           ...
           <td>
             <div class="dropdown">
               ...
               <div class="dropdown-menu">
                 ...
                 >
                 <form action="/retribusi/{{ $retribusi->tagihan }}" method="post" >
                   @method('delete')
                   @csrf
