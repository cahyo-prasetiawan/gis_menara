                ...
                <table>
                    <tbody >
                        <tr class="mb-xl-0 mb-1">
                            <td colspan="12" class="align-top px-12 py-1">
                            ...
                            <td colspan="30" class="text-end px-4 py-1">
                                <div>
                                    <?php
                                        $jam= Date("dmy");
                                        ?>
              ...
              <table class="table border-top m-0">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td colspan="3" class="align-top px-4 py-1">
                      <span>Cetakan, {{ $sekarang  }}</span>
                    </td>
                    <td class="text-end px-4 py-1">
