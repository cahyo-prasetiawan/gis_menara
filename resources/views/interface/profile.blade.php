...
<div class="container-fluid bg-white py-4  wow fadeIn" data-wow-delay="0.1s" >
  <div class="container text-center py-5" style="box-shadow: 0 2px">
      <h1 class=" text-black mb-4 animated slideInDown">My Akun</h1>
      <nav aria-label="breadcrumb animated slideInDown">
          <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="/home">Dasboard</a>
              </li>
              <li class="breadcrumb-item active">My Akun
              </li>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="card mb-4">
                ...
                <!-- Account -->
                <div class="card-body">
                  <form action="/akun/{{ Auth::user()->id }}/edit" method="POST" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                    @csrf
